...
FileAttachment("power_capacity_solar_SEA.csv").csv({typed: true})
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["power_capacity_solar_SEA.csv", {url: new URL("./files/aec3792837253d4c6168f9bbecdf495140a5f9bb1cdb12c7c8113cec26332634a71ad29b446a1e8236e0a45732ea5d0b4e86d9d1568ff5791412f093ec06f4f1.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
  ...
  main.variable(("nameframes")).define("nameframes", ["d3","keyframes"], _nameframes);
  main.variable(("prev")).define("prev", ["nameframes","d3"], _prev);
  main.variable(("next")).define("next", ["nameframes","d3"], _next);
  main.variable(("bars")).define("bars", ["n","color","y","x","prev","next"], _bars);
  main.variable(("labels")).define("labels", ["n","x","prev","y","next","textTween"], _labels);
  ...
  main.variable(("tickFormat")).define("tickFormat", _tickFormat);
  main.variable(("axis")).define("axis", ["margin","d3","x","width","tickFormat","barSize","n","y"], _axis);
